...
| «Почему ссылка в навыке битая?» | `docs/broken-refs.md` — инвентарь с причиной, состоянием и местом, откуда ресурс берётся (500 ссылок в шести категориях; 81 ведут во внешние проекты и каталоги запуска — например тетрадки `omicverse` в git-подмодуле) |
