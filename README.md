...
│   ├── validate.py            # валидатор репозитория: 12 проверок (спина CI)
...
| 2026-09-19 | Оформление по стандарту экосистемы: LICENSE, INSTALL, AGENTS, `validate.py` (12 проверок), живая диаграмма, Pages |
| 2026-09-19 | Собственный навык `abdominal-ct-findings`: таксономия 146 находок КТ брюшной полости (18 органов, 3 языка) + методика замера качества |
