...
Коммит: `edc9457`. Хеши ниже — sha256 файлов в этом коммите: если присланный архив совпадает по ним, значит он не из кеша.
...
| `.github/workflows/validate.yml` | 8850 | `77ae928ac4e16ff5…` |
