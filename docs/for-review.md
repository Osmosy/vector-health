...
Коммит: `a9acb5f`. Хеши ниже — sha256 файлов в этом коммите: если присланный архив совпадает по ним, значит он не из кеша.
...
| `scripts/validate.py` | 118818 | `41b764fd66640d2e…` |
...
| `.github/workflows/validate.yml` | 8272 | `c614fed63553cc35…` |
