...
**согласованный список находок** (146 позиций по 18 анатомическим структурам, с
названиями на трёх языках) и **методика честного замера** качества модели на
внешнем тесте.

Важно понимать границу области: 13 из 18 структур — органы брюшной полости
(печень, почки, поджелудочная, селезёнка, желудок, кишечник, жёлчный пузырь и
протоки, надпочечники, мочевой пузырь, аорта, воротная вена), а **5 — вне её**
(лёгкие, сердце, рёбра, пищевод, крестец). На них приходится 21 находка из 146:
КТ брюшной полости захватывает и нижние отделы грудной клетки, и это часть
замысла модели, а не ошибка таксономии.
...
- Важна граница области: 13 органов брюшной полости + 5 внебрюшных структур (лёгкие, сердце, рёбра, пищевод, крестец).
...
| # | Структура (RU) | Structure (EN) | Оригинал (ZH) | Находок | В брюшной полости |
|---|---|---|---|---|---|
| 1 | Аорта | Aorta | 主动脉 | 4 | да |
| 2 | Двенадцатиперстная кишка | Duodenum | 十二指肠 | 5 | да |
| 3 | Ободочная кишка | Large bowel | 大肠 | 18 | да |
| 4 | Тонкая кишка | Small bowel | 小肠 | 13 | да |
| 5 | Сердце | Heart | 心脏 | 2 | нет |
| 6 | Рёбра | Rib | 肋骨 | 3 | нет |
| 7 | Печень | Liver | 肝 | 18 | да |
| 8 | Лёгкие | Lung | 肺 | 10 | нет |
| 9 | Почки | Kidney | 肾 | 14 | да |
| 10 | Надпочечники | Adrenal gland | 肾上腺 | 6 | да |
| 11 | Желудок | Stomach | 胃 | 6 | да |
| 12 | Жёлчный пузырь и жёлчные протоки | Gallbladder / extrahepatic bile ducts | 胆囊 | 14 | да |
| 13 | Поджелудочная железа | Pancreas | 胰腺 | 10 | да |
| 14 | Селезёнка | Spleen | 脾 | 8 | да |
| 15 | Мочевой пузырь | Bladder | 膀胱 | 6 | да |
| 16 | Воротная вена | Portal vein | 门静脉 | 3 | да |
| 17 | Пищевод | Esophagus | 食管 | 5 | нет |
| 18 | Крестец | Sacrum | 骶骨 | 1 | нет |
| | **Итого** | | | **146** |
...
сопоставляется CSV модели). В JSON у каждой структуры есть `*_outside_abdomen`,
показывающий, входит ли она в брюшную полость.
